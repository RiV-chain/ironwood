...
type PacketConn interface {
	...
	HandleConn(domain Domain, conn net.Conn, prio uint8) error
	...
	// This could be used to do e.g. key discovery based on an incomplete domain, or to implement application-specific helpers for debugging and analytics.
	...
	SetOutOfBandHandler(handler func(fromDomain, toDomain Domain, data []byte)) error
