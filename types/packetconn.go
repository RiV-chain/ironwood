...
type PacketConn interface {
	...
	HandleConn(key []byte, conn net.Conn, prio uint8) error
	...
	SendOutOfBand(toKey []byte, data []byte) error
	...
	SetOutOfBandHandler(handler func(fromKey, toKey []byte, data []byte)) error
